    ...
    <nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
                ...
                <a class="navbar-brand" href="aboutUs.php"><span class="glyphicon glyphicon-"></span> About Us</a>
...
-->
    ...
    <h2 class="text-center"> Explore our Destinations</h2>
     <section class="slider room flex">
                    <div class="tm-rooms">
                        <img  src="Web_Project/images/Pokhara_YetiAirlines.jpg">
                       <a href="#"> <p class="s">Pokhara</p> </a>

                    </div>
                        <div class="tm-rooms">
                        <img  src="Web_Project/images/Bharatpur.jpg">
                            <a href="#"> <p class="s">Bharatpur</p></a>

                    </div>
                        <div class="tm-rooms">
                        <img  src="Web_Project/images/800px-Janaki_Mandir-Janakpur_Nepal-7499.jpg">
                            <a href="#">  <p>Janakpur</p></a>

                    </div>
                    <div class="tm-rooms">
                        <img  src="Web_Project/images/luxuryroom.png">
                       <a href="rooms.html"> <p class="s">Luxury Room</p> </a>

                    </div>
                        <div class="tm-rooms">
                        <img  src="Web_Project/images/deluxroom.png">
                            <a href="rooms.html"> <p>Delux Room</p></a>

                    </div>
                        <div class="tm-rooms">
                        <img  src="Web_Project/images/premiumroom.png">
